  ...
  if (isSuccess) {
    return (
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="pt-32 pb-20 px-6 max-w-lg mx-auto text-center">
        ...
        <p className="text-stone-600 mb-8">Please share your order details via WhatsApp after making your payment using the M-Pesa details provided.</p>
